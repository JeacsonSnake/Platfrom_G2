...
**Key Features:**
- 4-channel motor control with PWM output (GPIO 5-8)
- PID closed-loop speed control
- Encoder feedback via PCNT (Pulse Counter) on GPIO 11-**14**
...
- Flash: 8MB (detected), 2MB (configured in sdkconfig)
- PSRAM: 2MB
- USB: USB-Serial/JTAG
