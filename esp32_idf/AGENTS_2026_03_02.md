...
- Statistical reports every 5 minutes
...
- **Macros/Constants**: `UPPER_CASE_WITH_UNDERSCORES`
  - Example: `WIFI_SSID`, `LED_BLINK_FAST`, `LEDC_TIMER`, `NTP_SERVER_PRIMARY`
...
|------|----------|------------|-------------|
| LED_TASK | 4 | 4096 | Status LED indication (highest) |
| MONITOR_TASK | 3 | 4096 | MQTT connection monitoring |
| MQTT_INIT | 2 | 4096 | MQTT initialization (self-deleting) |
| MQTT_HB | 1 | 4096 | MQTT heartbeat sender |
| MQTT_CHK | 1 | 4096 | MQTT health check |
| MQTT_ERR | 1 | 2048 | MQTT error statistics report |
...
See archived documentation in the following directories for detailed troubleshooting records:

### `2026_02_10_wifi_test/`
...
### `2026_02_25_and_02_26_wifi_test/`
- MQTT connection monitoring implementation
- SNTP time synchronization
- Error diagnosis optimization
